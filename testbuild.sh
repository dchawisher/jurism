...
# run program
../zotero-standalone-build/staging/Jurism_linux-x86_64/jurism --ProfileManager -jsconsole -d 1
echo ../zotero-standalone-build/staging/Jurism_linux-x86_64/jurism --ProfileManager -jsconsole -d 1
